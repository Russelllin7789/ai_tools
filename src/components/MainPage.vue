          ...
          <div class="pb-[160px]">
            ...
            <div class="flex justify-between">
              <div class="p-10 w-[32%] rounded-2xl bg-[#1E1E1E]">
                ...
                <div class="flex">
                  <div class="w-[48px] h-[48px] rounded-full">
                    <img src="../assets/missChen.png" alt="ms-chen-avatar" />
                  </div>
              ...
              <div class="p-10 w-[32%] rounded-2xl bg-[#1E1E1E]">
                ...
                <div class="flex">
                  <div class="w-[48px] h-[48px] rounded-full">
                    <img src="../assets/missLiu.png" alt="ms-liu-avatar" />
                  </div>
                  <div class="ml-4 text-white">
                    <div>劉小姐</div>
                    <div>XYZ 醫療器材有限公司</div>
                  </div>
                </div>
              </div>
              <div class="p-10 w-[32%] rounded-2xl bg-[#1E1E1E]">
                ...
                <div class="flex">
                  <div class="w-[48px] h-[48px] rounded-full">
                    <img src="../assets/mrHuang.png" alt="mr-huang-avatar" />
                  </div>
                  <div class="ml-4 text-white">
                    <div>黃先生</div>
                    <div>EFG銀行</div>
            ...
            <ul class="flex items-center justify-between flex-wrap">
              ...
              >
                <div class="flex flex-col h-[560px]">
                  ...
                  >
                    <div
                      class="font-black text-xl mb-3 leading-[120%] text-black"
                    >
                      Chatbot Builder
                    </div>
                    <div
                      class="font-normal text-sm leading-[150%] text-[#525252]"
                    >
